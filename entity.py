...
class Entity:
    ...
    def move_towards(self, target_x, target_y, game_map, entities):
        ...
        if not (game_map.is_blocked(int(self.x) + dx, int(self.y) + dy) or
    ...
    def move_astar(self, target, entities, game_map):
        ...
        libtcod.path_compute(my_path, int(self.x), int(self.y), int(target.x), int(target.y))
...
def get_blocking_entities_at_location(entities, destination_x, destination_y):
    for entity in entities:
        if entity.blocks and int(entity.x) == int(destination_x) and int(entity.y) == int(destination_y):
            return entity
