...
from input_handlers import handle_keys, handle_mouse, handle_main_menu, handle_new_character_menu_keys
from loader_functions.initialize_new_game import get_constants, get_game_variables
from loader_functions.data_loaders import load_game, save_game
from menus import main_menu, message_box, new_character_screen
from entity import get_blocking_entities_at_location
from death_function import kill_player, kill_monster
...
def play_game(player, entities, game_map, message_log, game_state, con, panel, constants):
    ...
    while not libtcod.console_is_window_closed():
        ...
        if fov_recompute:
            recompute_fov(fov_map, int(player.x), int(player.y), constants['fov_radius'], constants['fov_light_walls'],
        ...
        if move and game_state == GameStates.PLAYER_TURN:
            ...
            message_log.add_message(Message('You are pass move.'))
        ...
        if take_stairs and game_state == GameStates.PLAYER_TURN:
            for entity in entities:
                ...
                message_log.add_message(Message('There are not stairs here.', libtcod.yellow))
        ...
        if save:
            ...
            message_log.add_message(Message('You are saved game!', libtcod.yellow))
        ...
        for player_turn_result in player_turn_results:
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(Message(
                        'You reached level {0}'.format(player.level.current_level) + '!', libtcod.yellow
                    ))
                    previous_game_state = game_state
    ...
    while not libtcod.console_is_window_closed():
        ...
        if show_main_menu:
            ...
            if show_load_error_message and (new_game or load_saved_game or exit_game):
                ...
                player, entities, game_map, message_log, game_state = get_game_variables(constants, 'barbarian')
                game_state = GameStates.PLAYER_TURN
                ...
                new_character_screen(con, main_menu_background_image, constants['screen_width'],
                                     constants['screen_height'])
                libtcod.console_flush()
                ...
                if action_character_menu.get('warrior') == warrior:
                    player, entities, game_map, message_log, game_state = get_game_variables(constants, warrior)
                    ...
                    player, entities, game_map, message_log, game_state = get_game_variables(constants, thief)
                    #game_state = GameStates.PLAYER_TURN
                    #show_character_screen = False
                    choose_fighter = False
